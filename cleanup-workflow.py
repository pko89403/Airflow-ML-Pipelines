...
SCHEDULE_INTERVAL = "@monthly"            # How often to Run. @daily - Once a day at Midnight (UTC)
...
DATABASE_OBJECTS = [                    # List of all the objects that will be deleted. Comment out the DB objects you want to skip.
    ...
    {"airflow_db_model": TaskInstance, "age_check_column": TaskInstance.execution_date, "dag_id": TaskInstance.dag_id, "keep_last_run": True},
    {"airflow_db_model": Log, "age_check_column": Log.dttm, "dag_id": Log.dag_id,"keep_last_run": True},
    {"airflow_db_model": XCom, "age_check_column": XCom.execution_date, "dag_id": XCom.dag_id,"keep_last_run": True},
    {"airflow_db_model": BaseJob, "age_check_column": BaseJob.latest_heartbeat, "dag_id": BaseJob.dag_id,"keep_last_run": True},
    {"airflow_db_model": SlaMiss, "age_check_column": SlaMiss.execution_date, "dag_id": SlaMiss.dag_id,"keep_last_run": True},
    {"airflow_db_model": DagModel, "age_check_column": DagModel.last_scheduler_run, "dag_id": DagModel.dag_id,"keep_last_run": True},
]
